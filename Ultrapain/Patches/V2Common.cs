...
namespace Ultrapain.Patches
{
    public static class V2Utils
    {
        public static Transform GetClosestGrenade()
        {
            ...
            foreach(Grenade g in UnityEngine.Object.FindObjectsOfType(typeof(Grenade)))
            {
            ...
            foreach (Cannonball c in UnityEngine.Object.FindObjectsOfType(typeof(Cannonball)))
            {
