...
namespace Ultrapain.Patches
{
    ...
    {
        static bool Prefix(VirtueInsignia __instance, ref Collider other)
        {
    ...
    class EnemyIdentifier_DeliverDamage_Crossmod
    {
        static bool Prefix(EnemyIdentifier __instance)
        {
            if (__instance.hitter == "stake")
            {
                __instance.nailsAmount += 1;
                __instance.hitter = "stake_spent";
            }
