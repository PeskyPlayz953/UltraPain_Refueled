...
namespace Ultrapain.Patches
{
    ...
    public class V2RocketLauncher : MonoBehaviour, IEnemyWeapon
    {
    ...
    class V2SecondSwitchWeapon
    {
        ...
        static bool Prefix(V2 __instance, ref int weapon)
        {
            ...
            int weaponSelected = weapons[UnityEngine.Random.RandomRangeInt(0, weapons.Length)];
